defmodule Workshop.Meta do
  ...
  @home "https://github.com/Tuxified/weert-workshop"
  @shortdesc "A starter workshop to learn Elixir while making a game"
  ...
  starting out with Elixir. During this workshop we will start creating a 5 card draw
